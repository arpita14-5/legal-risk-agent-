import type { Clause, StructuredContractMetadata } from '../types/shared.js';

export class ContractAgent {
  name = 'Contract Analysis Agent';

  async analyzeObligations(clauses: Clause[], metadata: StructuredContractMetadata): Promise<{ summary: string; keyObligations: string[] }> {
