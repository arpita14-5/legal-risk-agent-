import type { ClauseCategory, RiskCategory } from '../types/shared.js';

export interface LabeledClauseBenchmark {
  id: string;
  text: string;
  expectedCategory: ClauseCategory;
  expectedRisk?: RiskCategory;
  containsRisk: boolean;
}

export const EVALUATION_BENCHMARK_DATASET: LabeledClauseBenchmark[] = [
  {
    id: "bench-1",
