import type { ClauseCategory } from '../types/shared.js';
...
export function classifyClauseText(text: string, titleHint?: string): { category: ClauseCategory; confidence: number; favorableTo: 'mutual' | 'client' | 'counterparty' | 'unfavorable_to_all' } {
  let bestCategory: ClauseCategory = 'Miscellaneous';
  let maxScore = 0;
  ...
  let favorableTo: 'mutual' | 'client' | 'counterparty' | 'unfavorable_to_all' = 'mutual';
